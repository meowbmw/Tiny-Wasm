...
int64_t WasmFunction::executeWasmInstr() {
  ...
  auto instruction_set = getFunctionPointer<int64_t (*)(void *, void *, char *, int *, void *)>(full_instructions);
  ...
  int64_t ans = instruction_set(buffer, wasm_stack, globalVars, memorySizeKeeper, memoryInitializeFunction);
