...
int64_t WasmFunction::executeWasmInstr() {
  ...
  auto instruction_set = getFunctionPointer<int64_t (*)(void *, char *, void *, void *, void *, int)>(full_instructions);
  ...
  int64_t ans = instruction_set(buffer, globalVars, memorySizeKeeper, memoryInitializeFunction, memcpy_location, max_page);
