(module
  ...
  (table (;0;) 1 1 funcref)
  (memory (;0;) 1)
  (global (;0;) (mut i32) (i32.const 9456))
  (export "memory" (memory 0))
  (export "__indirect_function_table" (table 0))
  (export "_start" (func 4))
  (data (;0;) (i32.const 1024) "abc\00[test] %c %c %c %llu\0a\00[test] d is %lu\0a\00[test] d is %u\0a\00[test] %c %c %c %u\0a\00[test] c is %c, s is %s\0a\00[test] str is %s\0a\00[test] data is %p\0a\00[test] d is %i\0a\00[test] %c %c %c %lld\0a\00[test] -d is %d\0a\00[test] %c %c %c %d\0a\00[test] data is %p %c\0a\00"))
